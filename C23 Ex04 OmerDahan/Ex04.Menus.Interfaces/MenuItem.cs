    ...
    public class MenuItem
    {
        ...
        internal void Show()
        {
            ...
            if (this.r_SubMenuItems.Count != 0)
            {
                ...
                Console.WriteLine(divider);
                menuSelectionMessage = string.Format("Enter your request: (1 to {0} or press 0 to {1}).", this.r_SubMenuItems.Count - 1, backOrExit);
            ...
            {
                chosenMenuItem = this;
                ((MenuAction)chosenMenuItem)?.PreformAction();
        ...
        {   
            return this.r_HasParentMenuItem ? "Back" : "Exit";
        }
        ...
        private void printSubMenuItems()
        {
            ...
            {
                if (subMenuItem.MenuItemIndex != 0)
                {
